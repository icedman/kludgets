/*
Copyright i?? 2004, Apple Computer, Inc.  All rights reserved.
...
function createGenericButton (div, title, onaction, minwidth)
{
        ...
        element.setAttribute ("style", 'display:inline-block;line-height:23px;background:url(file:///System/Library/WidgetResources/button/glassbuttonleft.png) repeat-x top left;min-width:10px;');
        element.innerHTML = "&nbsp;";
        ...
        element = document.createElement('div');
        element.setAttribute ("style", 'display:inline-block;line-height:23px;background:url(file:///System/Library/WidgetResources/button/glassbuttonright.png) repeat-x top left;min-width:10px;');
        element.innerHTML = "&nbsp;";
        div.appendChild (element);
...
function genericButtonMouseDownHandler(event, div)
{
        ...
        {
                div.childNodes[0].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonleftclicked.png)';
                div.childNodes[1].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonmiddleclicked.png)';
                div.childNodes[2].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonrightclicked.png)';
        }
...
function genericButtonMouseOverHandler (event)
{
        ...
        {
                genericButtonCurrentMouseDownButton.childNodes[0].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonleftclicked.png)';
                ...
                genericButtonCurrentMouseDownButton.childNodes[2].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonrightclicked.png)';
        }
...
function genericButtonMouseOutHandler (event)
{
        if (genericButtonCurrentMouseDownButton && genericButtonCurrentMouseDownButton.genericButtonEnabled)
        {
                genericButtonCurrentMouseDownButton.childNodes[0].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonleft.png)';
                genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(url(file:///System/Library/WidgetResources/button/glassbuttonmiddle.png)';
                genericButtonCurrentMouseDownButton.childNodes[2].style.backgroundImage = 'url(file:///System/Library/WidgetResources/button/glassbuttonright.png)';
        }
